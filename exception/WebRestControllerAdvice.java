...
public class WebRestControllerAdvice extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponseMsg> handleNotFoundException(CustomerNotFoundException ex) {
	...
	public ResponseEntity<ResponseMsg> handleInsuranceNotFoundException(InsuranceNotFoundException ex) {
		ResponseMsg responsemsg = new ResponseMsg();
